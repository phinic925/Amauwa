...
<div className='flex justify-end'>
  ...
  {/* Card 1 */}
  <div className='flex flex-col items-center justify-start bg-navy text-white border p-4 shadow-lg h-full transition-transform transform cursor-pointer max-w-xs'>
